...
extension ImageViewerScreen: ViewCode {
  ...
  //          self.contentView.widthAnchor.constraint(equalToConstant: 800),
...
//            self.imageExplanationLabel.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 12),
//            self.imageExplanationLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -12),
//
